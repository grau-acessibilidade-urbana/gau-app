                ...
                <ScrollView style={styles.details}>
                    <View style={styles.containerTitle}>
                        ...
                        <View style={styles.containerStar}>
                            <Icon name='star' size={27} color={commonStyle.colors.FullStar}></Icon>
